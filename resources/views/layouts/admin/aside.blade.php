    ...
    <ul class="app-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          @include('components.inc.sub_menu', ['route' => route('admin.cashbook.entries.add'), 'label' => 'Entry'])
        </ul>
      </li>
      ...
      <li class="treeview">
        <a class="app-menu__item" href="#" data-toggle="treeview">
            <i class="app-menu__icon bi bi-laptop"></i>
            <span class="app-menu__label">Slider Manage</span>
            <i class="treeview-indicator bi bi-chevron-right"></i>
        </a>

        <ul class="treeview-menu">
          <li>
            <a class="treeview-item" href="{{route('admin.sliders.list')}}">
                 <span class="submenu"> Slider List</span>
            </a>
          </li>
        </ul>
      </li>
